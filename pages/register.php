                ...
                <h2>Registrar Libros</h2>
                    ...
                    <form method="post" class="row g-3" action="../functions/create.php">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="precio" name="precio" value="" min="0" oninput="validity.valid||(value='');" required>
                        </div>
                        <div class="col-md-6">
                            <label for="cantidad" class="form-label">Cantidad:</label>
                            <input type="number" class="form-control" id="cantidad" name="cantidad" value="" min="0" oninput="validity.valid||(value='');" required>
                        </div>
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary">Registrar nuevo libro</button>
                        </div>
                    </form>
            </main>
        </div>
