    ...
    <div class="container-fluid">
        <div class="row">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    <a class="navbar-brand active" href="index.php"><i data-feather="home"></i> Inicio</a>
    ...
    <tbody>
        <?php foreach ($libros as $libro): ?>
            <tr>
                ...
                <td>
                    <a href="functions/update.php?id=<?php echo $libro['id']; ?>" class="btn btn-warning btn-sm">
                        <i class="bi bi-pencil-square"></i> Editar
                    </a>
                    <a href="functions/delete.php?id=<?php echo $libro['id']; ?>" class="btn btn-danger btn-sm">
